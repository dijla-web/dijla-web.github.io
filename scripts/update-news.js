...
- إذا كان الخبر عن تأثير الاحتباس الحراري على العراق تحديداً (موجة حر ببغداد مثلاً) → هذا لا يدخل بأي فئة من فئاتك الثمانية، تجاهله (الموقع أصلاً يغطي هذا الموضوع بمحتوى ثابت). لا تحاول توزيعه بالقوة على "river" أو "climate".
...
- لا تنشئ فئة جديدة ولا تخترع تسمية غير الثمانية المذكورة أعلاه. إذا الخبر ما ينطبق تماماً وبدقة على فئة واحدة منها، لا تدرجه إطلاقاً — تجاهله بالكامل. الدقة أهم من الكمية.
